...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Okt 2023 pada 04.14
...
(11, 'Atsn', 'Atasan Wanita Beige', '90000', 'Levis', 'Panjang', 'L', '9', '2022-12-29', 'Baju atasan wanita, cocok di pake buat santai', 'WhatsApp_Image_2023-07-05_at_07_27_03_(1).jpeg'),
(12, 'Atsn-02', 'Atasan wanita frost', '90000', 'Levis', 'Separo', 'L', '36', '2023-01-11', 'Baju atasan ini sangat lembut, cocok dipakai berpergian kemanapun', 'WhatsApp_Image_2023-07-05_at_07_26_57_(1).jpeg'),
...
(41513, 3, 'pelanggan1', '08383332131', 'pelanggan1@gmail.com', '$2y$10$rq/A4OUCXw2VqgldeXpBs.rGONtdCHs.B4oH3KPrhW9fnoV.JKPTu', 'Kecamatan maleber, kuningan'),
(82159, 3, 'Irfan Maulana', '0897754321', 'irfanmaulana@gmail.com', '$2y$10$zzJ0FhZNh7x9b7iITyzSqet59Pz4bDJb3E4Fsn/JNj6VIiYeJqypO', 'Langseb'),
...
--
ALTER TABLE `chat`
  MODIFY `id_chat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=261;

--
-- AUTO_INCREMENT untuk tabel `checkout`
--
ALTER TABLE `checkout`
  MODIFY `id_checkout` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
...
--
ALTER TABLE `refund`
  MODIFY `id_refund` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
