...
<script type="text/javascript">
   $(document).ready(function(){
      ...
      //    })
      //    let btn_sending = $(this).attr("href", "https://api.whatsapp.com/send?phone=6283824587800&text=Hallo Kak saya "+namapemesan+" ingin pesan "+text+" ke alamat "+alamatpemesan)
